...
public final class FindMeetingQueryTest {
  ...
  // Test 1 TDD - WEEK 5
  @Test 
  public void optionalAttendeeWithFullDayMeeting() {
    Collection<Event> events = Arrays.asList(
        new Event("Event 1", TimeRange.fromStartDuration(TIME_0800AM, DURATION_30_MINUTES),
            Arrays.asList(PERSON_A)),
        new Event("Event 2", TimeRange.fromStartDuration(TIME_0900AM, DURATION_30_MINUTES),
  ...
  // Test 2 TDD - WEEK 5
  @Test 
  public void optionalAttendeeWithShortMeeting() {
    Collection<Event> events = Arrays.asList(
        new Event("Event 1", TimeRange.fromStartDuration(TIME_0800AM, DURATION_30_MINUTES),
            Arrays.asList(PERSON_A)),
        new Event("Event 2", TimeRange.fromStartDuration(TIME_0900AM, DURATION_30_MINUTES),
  ...
  // Test 3 TDD - WEEK 5
  @Test 
  public void optionalAttendeeShortMeetingIgnored() {
    Collection<Event> events = Arrays.asList(
        new Event("Event 1", TimeRange.fromStartEnd(TimeRange.START_OF_DAY, TIME_0830AM, false),
            Arrays.asList(PERSON_A)),
        new Event("Event 2", TimeRange.fromStartEnd(TIME_0900AM, TimeRange.END_OF_DAY, true),
  ...
  // Test 4 TDD - Week 5
  @Test
  public void noMandatoryMeetingsWithGaps() {
    Collection<Event> events = Arrays.asList(
  ...
  // Test 5 TDD - Week 5 
  @Test
  public void noMandatoryMeetingsWithoutGaps() {
    Collection<Event> events = Arrays.asList(
        new Event("Event 1", TimeRange.WHOLE_DAY, Arrays.asList(PERSON_A, PERSON_B))
    );
